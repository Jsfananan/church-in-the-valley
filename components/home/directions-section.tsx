          ...
          <div className="lg:col-span-2 flex flex-col justify-center gap-6">
            ...
            <div className="bg-church-cream rounded-2xl p-6 sm:p-8 border border-church-border">
              ...
              <div className="space-y-3 text-sm">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-church-gold shrink-0" aria-hidden="true">
                ...
                >
                  ...
                  <span>{CONTACT.pastorName} — {CONTACT.pastorEmail}</span>
                </a>
                <a
                ...
                >
                  ...
                  <span>{CONTACT.pastorName} — {CONTACT.pastorPhone}</span>
                </a>
              </div>
            </div>
